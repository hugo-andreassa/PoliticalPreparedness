...
import com.example.android.politicalpreparedness.databinding.ListRepresentativeBinding
...
class RepresentativeViewHolder(val binding: ListRepresentativeBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    companion object {
        fun from(parent: ViewGroup): RepresentativeViewHolder {
            ...
            val binding = ListRepresentativeBinding.inflate(layoutInflater, parent, false)
